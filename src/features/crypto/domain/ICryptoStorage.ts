...
export interface ICryptoStorage {
  ...
  getConversationKey(conversationId: string, keyVersion: number): Promise<IConversationKey | null>;

  getLatestConversationKey(conversationId: string): Promise<IConversationKey | null>;
